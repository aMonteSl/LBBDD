...
'''
7. Ejecuta la misma consulta utilizada en el ejercicio 5 y mide nuevamente el tiempo que tarda en
ejecutarse. Compara los resultados con los obtenidos antes de crear el índice.
'''

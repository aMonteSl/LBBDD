...
'''
1. Elabora un script en Python üniversidad.py"que gestione la conexión a la base de datos DVDren-
tal. El Script deberá permitir la conexión a la base de datos mediante el uso de un archivo de
configuración çonfig.ini", gestionar posibles errores de conexión y terminar cerrando la conexión.
'''
